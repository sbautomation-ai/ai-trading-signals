...
//
// Docs & endpoint example: https://financialmodelingprep.com/api/v3/economic_calendar?from=2020-08-05&to=2020-10-20&apikey=YOUR_API_KEY
...
interface CalendarEvent {
  ...
  export async function GET(request: Request): Promise<Response> {
    try {
        ...
        return json(
          {
            ...
            from,
            to,
            note: 'Static demo data returned because FMP_API_KEY is not configured.',
          },
          { status: 200 }
        );
      }
      ...
      logError('Unhandled error in /api/economic-calendar', { message });
      return json(
        {
          error: 'Internal error while fetching economic calendar.',
        },
        { status: 500 }
      );
    }
